...
class Pembeli {
    ...
    public void beliTiket(TiketF1 tiket, int jumlah) {
...
public final class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1: lihatTiket(); break;
                case 2: beliTiket(); break;
                case 3: lihatTiketSaya(); break;
                case 4: batalTiket(); break;
    ...
    private static void menuAdmin() {
        while (true) {
            ...
            switch (pilihan) {
                case 1: tambahTiketVIP(); break;
                case 2: tambahTiketGrandstand(); break;
                case 3: perbaruiStok(); break;
                case 4: return;
